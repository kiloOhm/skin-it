        ...
        public void registerImage(Plugin plugin, string name, string url, Action callback = null, bool force = false, int? imgSizeX = null, int? imgSizeY = null)
        {
            ...
            else
            {
                if (imgSizeX != null && imgSizeY != null)
                {
                    ...
                    {
                        //byte[] img = ImageLoader.Resize(b, imgSizeX.Value, imgSizeY.Value);
                        //(bool)AddImageData(string imageName, byte[]array, ulong imageId, Action callback = null)
                        ImageLibrary.Call("AddImageData", safeName, b, (ulong)0, callback);
                    }, imgSizeX, imgSizeY));
                }
                else
                {
...
namespace Oxide.Plugins
{
    ...
    public partial class GUICreator
    {
        ...
        {
            private const string flagSymbols = "/-";
...
namespace Oxide.Plugins
{
    ...
    public partial class GUICreator
    {
        public class GuiContainer : List<GuiElement>
        {
            ...
            private ExtendedCuiElementContainer CuiContainer
            {
                get
                {
...
namespace Oxide.Plugins
{
    ...
    public partial class GUICreator
    {
        ...
        {
            public IEnumerator DownloadImage(string url, Action<byte[]> callback, int? sizeX = null, int? sizeY = null)
            {
...
namespace Oxide.Plugins
{
    ...
    public partial class GUICreator
    {
        ...
        public class Rectangle : CuiRectTransformComponent
        {
            ...
            private double[,] AnchorData = new double[9, 4]
            {
                {0, 0, 0, 0 },
                {0.5d, 0, 0.5d, 0 },
                {1, 0, 1, 0 },
